...
class ExpectationsAccumulator(extractor : ExpectationsExtractor) {
  ...
  private val extractGet = extract[Get]("/get.expectations")
  private val extractPost =  extract[Post]("/post.expectations")
  private val extractPut = extract[Put]("/put.expectations")
  private val extractDelete = extract[Delete]("/delete.expectations")
